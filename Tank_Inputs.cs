   ...
   void Start(){
    ...
    protected virtual void HandleInputs(){
        ...
        if(Physics.Raycast(screenRay, out hit)){
            ...
            targetTransform.transform.rotation= Quaternion.LookRotation(targetNormal, Vector3.up);
            if(hit.transform.CompareTag("Enemy")){
                Debug.Log("Enemy:Setting Color Green");
             targetRenderer.material.color = new Color(0.4901f, 1f, 0.1764f,  1f);
             targetRenderer.material.SetColor("_EmissionColor", new Color(0.4901f, 1f, 0.1764f,  0.5f));
            }
            else{
        ...
        if(rightTrackAnim && leftTrackAnim !=null){
            ...
            // Stop opposite side track while turning
    ...
    protected virtual void HandleShoot(){
        ...
        //     //play cannon move animation
        //         tankCannon.GetComponent<Animator>().Play("cannon_shoot_anim");
